    ...
    Public Class SqlDB
        ...
        Private Shared ReadOnly Property INIFileName() As IniReader
            Get
                ...
                Dim INIFlie As String = Application.StartupPath() & "\XCS-Convert.ini"
...
#Region "MAPPING DB SQL Connection"
        Public Shared ReadOnly Property MappingDBDataSource() As String
            Get
                ini.Section = "MAPPING_DB_SQL"
                Return ini.ReadString("ServerName").ToString
            End Get
        End Property
        Public Shared ReadOnly Property MappingDBDbName()
            Get
                ini.Section = "MAPPING_DB_SQL"
                Return ini.ReadString("DbName").ToString
            End Get
        End Property
        Public Shared ReadOnly Property MappingDBDbUserID() As String
            Get
                ini.Section = "MAPPING_DB_SQL"
                Return ini.ReadString("DbUserID").ToString
            End Get
        End Property
        Public Shared ReadOnly Property MappingDBDbPwd() As String
            Get
                ini.Section = "MAPPING_DB_SQL"
        ...
        Protected Shared ReadOnly Property MappingDBConnectionString() As String
            Get
                Try
                    Dim s As String = "Data Source=" & MappingDBDataSource() & ";Initial Catalog=" & MappingDBDbName() & ";User ID=" & MappingDBDbUserID() & ";Password=" & MappingDBDbPwd()
                    Return s
        ...
        Public Shared Function GetMappingDBConnection() As SqlConnection
            '#check
            Dim conn As SqlConnection
            Try
                conn = New SqlConnection(MappingDBConnectionString)
                conn.Open()
                Return conn
