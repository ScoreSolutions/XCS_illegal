...
<input type="hidden" name="suspect_type" id="suspect_type" value="2"/>
<tr>
<td valign="top"><!-- Body -->
...
<tr>
    ...
    <td width="30%"><input type="text" name="suspect_passport"
    ...
    <td colspan="3"><select name="title_code">
        ...
        <c:forEach items="${titles}" var="title" varStatus="i">
            <option value="${title.title_code}">${title.short_title}</option>
                           ...
                           size="15">
        ชื่อกลาง :&nbsp;
        <input type="text" name="middle_name" class="textbox" size="15">
        นามสกุล :&nbsp;
