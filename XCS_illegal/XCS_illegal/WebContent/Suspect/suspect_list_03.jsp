...
//response.setContentType("text/html; charset=UTF-8");
 ...
 String targetToken = "Suspect.jsp?action=suspectList03&";
 String replaceToken = "Suspect/suspect_list_03.jsp?";
		  ...
		  <tr>
			...
			<td width="100%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
							...
							<td width="260" valign="middle">	  
								  <select name="action">
									...
									<option value="suspectList02">คนต่างชาติ</option>
									<option value="suspectList03" selected>ผู้ประกอบการ</option>
								  </select>
              ...
              <tr>
                ...
                <td><table width="800" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                  <tr>
                    ...
                    <form method="post" action="Suspect.jsp?action=suspectList03">
                    
                    <table width="800" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5">
                        
                        <tr>
                          <td>&nbsp;</td>
                          <td align="left" valign="top"><span class="sectionname">ค้นหาข้อมูลต้องสงสัย :: ผู้ประกอบการ</span></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        ...
                        <tr id="sp_row">
                          <td>&nbsp;</td>
                          <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="sp_thai">
                              <tr>
                                <td width="20%" height="25" align="right">เลขทะเบียนนิติบุคคล :&nbsp;</td>
                                <td width="30%"><input type="text" name="corporation_code" class="textbox"/></td>
                                <td width="20%" align="right">เลขทะเบียนสรรพสามิต :&nbsp;</td>
                                <td width="30%"><input type="text" name="excise_reg_no" class="textbox"/></td>
                              </tr>
                              <tr>
                                <td height="25" align="right">เลขที่ใบอนุญาต :&nbsp;</td>
                                <td><input type="text" name="license_no" class="textbox"/></td>
                                <td align="right">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
                              <tr>
                                <td height="25" align="right">ชื่อผู้ประกอบการ :&nbsp;</td>
                                <td colspan="3"><input name="company_name" type="text" class="textbox" size="70"/></td>
                                </tr>
                              <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td height="30">
					<span class="spanLink" onClick="MM_goToURL('parent','Suspect.jsp?action=CompanyForm');
              ...
              <tr>
                ...
                <jsp:include page="/QueryPager/trader_suspect_pager.jsp"/>
