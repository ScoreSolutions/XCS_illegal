	...
	<tr>
		<td width="100%" align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
            	 	<td width="99%" height="40"><span class="header">รายงานผลการตรวจค้น</span></td>
            	</tr> 
					...
					function report(){
					 ...
					 var dateto;
						...
						if(compare_case_date==""||compare_case_date1==""){
							...
							if(sector_code==""){
								alert ('process?action=Report&__report=ILLR8201_1&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
								window.open('process?action=Report&__report=ILLR8201_1&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
							}
							else{
								alert ('process?action=Report&__report=ILLR8201&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
				    			...
				    			window.open('process?action=Report&__report=ILLR8201&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
								'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
   							}
   						}
					}
