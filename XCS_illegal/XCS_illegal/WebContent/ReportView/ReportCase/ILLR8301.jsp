...
<!-- Body -->
	...
	<td width="100%" align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
            		<td width="99%" height="40"><span class="้header">รายงานผลคดี ส.ส.2/55</span></td>
            	</tr> 
				...
				<tr>
                	<td height="35" align="left" valign="middle">วันที่ทำรายงาน :
						  <input name="compare_case_date" id="compare_case_date" type="text" class="textdate" onkeypress="window.event.keyCode = 0;" value="" cc.compare_case_date="" timeZone="th-TH"/>
				 	  	...
				 	  	<img src="images/btn_calendar.png" alt="" width="19" height="19" align="middle" style="border-style: none"/></a> <font style="color: red">*</font> 
						ถึงวันที่ :  
		...
		<table width="800" border="0">
			<tr>
				<td colspan="4"><span class="header2">ประเภทรายงาน</span></td>
			</tr>
	 	...
	 	<table border="0" style="width: 324px; height: 110px">
			<tr><input name="btnBack" type="button" class="barbutton" value="รายงาน" onClick="report('pdf');"/>
              	 <script type='text/javascript'>
					...
					function report(){
					 ...
					 var dateto;
						...
						if(compare_case_date==""||compare_case_date1==""){
				    		...
				    		window.open('process?action=Report&__report=ILLR8301&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
							'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
						}
					}
				</script>
