...
<!-- Body -->
	...
	<td width="100%" align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
            	<td width="99%" height="40"><span class="header">รายละเอียดหน้างบรายงานผลคดีตาม พ.ร.บ.</span></td>
            </tr> 
					 ...
					 var dateto;
						...
						dateto=yearto+'-'+monthto+'-'+dayto;
   						...
   						if(compare_case_date==""||compare_case_date1==""){
							...
							alert ('process?action=Report&__report=ILLR8305&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
							'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
				   			 window.open('process?action=Report&__report=ILLR8305&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
							'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
						}
					}
				</script>
