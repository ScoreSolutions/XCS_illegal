...
<form method="post" name="dataform" action="<c:url value="/process?action=OtherStaffList_Master&cmd=create"/>" >
			...
			<td width="100%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td>
					...
					<input name="btnCancel"  type="button" class="barbutton" value="ยกเลิกการแก้ไข" onclick="javascript:location.href='<c:url value="/process?action=OtherStaffList_Master&cmd=add"/>'">
                ...
                <td>
						<table border="0" cellpadding="0" cellspacing="0" width="1000">
							<tr>
                				...
                				<td width="30%">
									<input name="staff_idcardno" type="text" class="textview" value="" size="25" readonly />
								</td>
							...
							<tr>
                				...
                				<td colspan="3">
										<select name="staff_offcode" style="width:100" >
											  ...
											  <option value="${titlelist.title_code }">${titlelist.title_name }</option>
						
											  </c:forEach>
										</select>&nbsp;&nbsp;
										<input type="text" name="staff_first_name" class="textbox" size="15" value="">
										&nbsp;&nbsp;&nbsp;
										<input type="text" name="staff_last_name" class="textbox" size="15" value="">
							...
							<tr>
								...
								<td height="25" colspan="3" >
								   <input type="text" name="staff_poscode" size="50"  class="textbox"  value="" >
								   <font style="color:red">*</font>
								</td>
                			</tr>
							<tr>
								...
								<td height="25" colspan="3" >
								   <input type="text" name="staff_level" size="50"  class="textbox"  value="" >
								   <font style="color:red">*</font>
								</td>
                			</tr>
                			<tr>
								...
								<td height="25" >
								    <input type="Text" id="start_date" name="start_date" size="15" class="textdate" value="" readonly /> 
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									วันที่ออก :&nbsp;
									<input type="Text" id="end_date" name="end_date" size="15" class="textdate" value="" readonly /> 
							...
							<tr>
								<td align="right">&nbsp;</td>
								<td height="25" >
								   	 <input type="checkbox" name="active" value="1" checked />ใช้งาน
								</td>
                			</tr>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
  	...
  	//frmvalidator.addValidation("staff_level","maxlen=200","จำนวนตัวอักษรยาวเกิน 200 ตัวอักษร ");

	frmvalidator.addValidation("staff_level","req","กรุณาป้อน สังกัด");
