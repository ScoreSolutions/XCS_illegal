...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.30 ผลการปราบปรามผู้กระทำผิดกฏหมายสรรพสามิต แต่ละพ.ร.บ. ประจำเดือน</span></td>
            </tr>
...
function report(){
	...
	if(monthfrom == ""){
		...
		var param = 'process?action=Report&__report=ILLR8130&__formatt=pdf&vMonth='+monthfrom2+'&vYear='+year1+'&getUserID='+user_id;
		//alert(param);
