...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.27 ผลการปราบปรามจับกุมผู้กระทำผิด พ.ร.บ.ยาสูบ</span></td>
            </tr>
            	...
            	<td>
            		<table width="600" border="0" cellpadding="0" cellspacing="0" >
						<tr>
							...
							<td width="20%" align="center">ถึง :&nbsp;</td>	
							<td width="30%" align="left">
...
function report(){
	...
	if(year1 != "" && year2 != ""){
		year1 = year1-543;
		year2 = year2-543;
		var param = 'process?action=Report&__report=ILLR8127&__formatt=pdf&getYearFrom='+year1+'&getYearTo='+year2+'&getUserID='+user_id;
		//alert(param);
