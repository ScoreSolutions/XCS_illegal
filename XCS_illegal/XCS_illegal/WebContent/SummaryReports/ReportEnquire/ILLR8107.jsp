...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.7 ผลการปราบปรามคดีเครื่องปรับอากาศ</span></td>
            </tr>
...
function report(){
	...
	if(year1 != ""){
		var param = 'process?action=Report&__report=ILLR8107&__formatt=pdf&vYear='+vYear+'&vOffcode1='+vOffcode1+'&vOffcode2='+vOffcode2+'&vOffcode3='+vOffcode3+'&getUserID='+user_id;
		alert (param);
