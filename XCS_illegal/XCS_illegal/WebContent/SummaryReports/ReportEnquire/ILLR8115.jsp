...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.15 สถิติผลการปราบปรามผู้กระทำผิดกฎหมายสรรพสามิตในส่วนกลางและส่วนภูมิภาค</span></td>
            </tr>
...
function report(){
  	...
  	var vMonth=document.getElementById("monthfrom").value.substring(3,1);
	...
	if(vMonth == ""){
		...
		var param = 'process?action=Report&__report=ILLR8115&__formatt=pdf&vMonth='+vMonth+'&vYear='+year1+'&getUserID='+user_id;
		//alert(param);
