		...
		<td width="100%"align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			 	<tr>
			 		<td width="1%">&nbsp;</td>
	              	<td width="99%">
	              		<span class="websitename">5.6 หน้างบผลการปราบปรามผู้กระทำผิดประจำเดือน (พ.ร.บ.ภาษีสรรพสามิต 2527)</span>
	              	</td>
	            </tr> 
...
function report(){
	...
	if(monthfrom != "" && monthto != "" && year1 != ""){
  		var param = 'process?action=Report&__report=ILLR8506&__formatt=pdf&getMonthfrom='+datefrom+
