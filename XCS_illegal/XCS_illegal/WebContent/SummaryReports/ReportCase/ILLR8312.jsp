	...
	<tr>
		<td width="100%" align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="1%">&nbsp;</td>
            		<td width="99%" ><span class="websitename">3.12 สรุปใบเสร็จรับเงิน</span></td>
            	</tr> 
	             	...
	             	<td>
	             		<table width="700" border="0" cellpadding="0" cellspacing="0" >
	             			<tr>
	             				<td width="20%">&nbsp;</td>
	             				<td width="80%">
									<input type="radio" name="group2" id="inv"  checked=""/>สรุปใบเสร็จรับเงิน
				             		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				             		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				             		<input type="radio" name="group2" id="voidInv" />สรุปใบเสร็จเสีย
	             				</td>
	             			</tr>
	             			<tr>
								<td height="40px">&nbsp;</td>
   						...
   						if(compare_case_date==""||compare_case_date1==""){
							...
							if(document.getElementById("inv").checked){
								Reports.ReportUrl(function(data){
									if(data != ""){
										window.open(data + 'ReportName=ILLR8312&vReportType=PDF&getDatefrom='+datefrom+'&getDateto='+dateto+
										...
										window.open('process?action=Report&__report=ILLR8312&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
												'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getUserID='+user_id + '&time=' + Math.random(), 
												'_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
									}
								});
								...
								Reports.ReportUrl(function(data){
									if(data != ""){
										window.open(data + 'ReportName=ILLR8312_1&vReportType=PDF&getDatefrom='+datefrom+'&getDateto='+dateto+
												'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getUserID='+user_id + '&time=' + Math.random(),
												'_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
									}else{
										window.open('process?action=Report&__report=ILLR8312_1&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
												'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getUserID='+user_id + '&time=' + Math.random(), 
												'_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
									}
								});
