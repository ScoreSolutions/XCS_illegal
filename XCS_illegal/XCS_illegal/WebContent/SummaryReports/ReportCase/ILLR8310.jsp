...
<script type='text/javascript' src='/XCS_illegal/dwr/util.js'></script>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			 	<tr>
			 		<td width="1%">&nbsp;</td>
	         	 	<td width="99%"><span class="websitename">3.10 สรุปผลรายงานผลคดี (คดี) เลือกปีงบประมาณ</span></td>
	         	</tr>   
	 ...
	 var user_id = "<%=RequestUtil.getUserSession(request).getIdCard()%>";
		...
		if(year1==""){
			...
			Reports.ReportUrl(function(data){
				if(data != ""){
					window.open(data + 'ReportName=ILLR8310&vReportType=PDF&getYear1='+year1 + '&getYear2='+year2 +
					...
					window.open('process?action=Report&__report=ILLR8310&__formatt=pdf&getYear1='+year1 + '&getYear2='+year2 +
