...
<script type='text/javascript' src='dwr/util.js'></script>
	...
	<td width="100%" align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td width="1%">&nbsp;</td>
            		<td width="99%" ><span class="websitename">3.2 รายงานผลคดี ส.ส.2/55(กรณีปรับย้อนหลัง)</span></td>
            	</tr> 
					 ...
					 var dateto;
						...
						if(compare_case_date==""||compare_case_date1==""){
							...
							Reports.ReportUrl(function(data){
								if(data != ""){
									window.open(data + 'ReportName=ILLR8302&vReportType=PDF&getDatefrom='+datefrom+'&getDateto='+dateto+
									...
									window.open('process?action=Report&__report=ILLR8302&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
											'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getUserID='+user_id, 
											'_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
								}
							});
