	...
	<tr>
		<td width="100%" align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="1%">&nbsp;</td>
            	 	<td width="99%" height="40"><span class="websitename">2.2 รายงานการกระทำผิดกฎหมายสรรพสามิต</span></td>
            	</tr> 
					...
					function report(){
					 ...
					 var dateto;
						...
						if(compare_case_date==""){
							...
							var param = 'process?action=Report&__report=ILLR8202&__formatt=pdf&vDateFrom='+datefrom+'&vDateTo='+dateto+
