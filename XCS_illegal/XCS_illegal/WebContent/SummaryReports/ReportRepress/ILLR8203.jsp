...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td width="100%" align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">		
			<tr>
				<td width="1%">&nbsp;</td>
            	<td width="99%" ><span class="websitename">2.3 รายงานการกระทำผิดกฎหมายสรรพสามิต</span></td>
            </tr> 
					...
					function report(){
					 ...
					 var dateto;
						...
						if(compare_case_date==""){
							...
							var param;
							param = '&getDatefrom='+datefrom+'&getDateto='+dateto+'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getLegislationid='+legislation_id+'&getUserID='+user_id + '&time=' + <%= new java.util.Date().getTime() %>;
			    			
			    			Reports.ReportUrl(function(data){
								if(data != ""){
									window.open(data + 'ReportName=ILLR8203&vReportType=PDF' + param, '_blank' , 'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
								}else{
									window.open('process?action=Report&__report=ILLR8203&__formatt=pdf' + param, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
								}
							});
   						}
   					}
