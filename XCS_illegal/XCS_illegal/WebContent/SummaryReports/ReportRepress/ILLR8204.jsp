		...
		<tr>
			<td width="100%" align="left" valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="1%">&nbsp;</td>
		            	<td width="99%" height="40"><span class="websitename">2.4 รายงานสรุปการกระทำผิดรายตัว (แบบ Statement)</span></td>
		            </tr> 
								...
								if(compare_case_date==""){
									...
									if(sector_code==""){
										...
										Reports.ReportUrl(function(data){
											if(data != ""){
												window.open(data + 'ReportName=ILLR8204_1&vReportType=PDF' + param, '_blank' , 'menubar=no,toolbar=yes,resizable=yes,location=yes,scrollbars=no,width=900,height=700');
											}else{
												window.open ('process?action=Report&__report=ILLR8204_1&__formatt=pdf'+param, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=yes,scrollbars=no,width=900,height=700');
											}
										});
									}
									else{
										...
										Reports.ReportUrl(function(data){
											if(data != ""){
												window.open(data + 'ReportName=ILLR8204&vReportType=PDF' + param, '_blank' , 'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
											}else{
												window.open ('process?action=Report&__report=ILLR8204&__formatt=pdf' + param, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
											}
										});
									}
								}
