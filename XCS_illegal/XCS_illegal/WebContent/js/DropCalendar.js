...
function OpenCal(pCtrl,pFormat)
{
 ...
 Cal=new Calendar(dtToday);       
	...
	if (exDateTime!=null && exDateTime!="" && exDateTime!="undefined")//Parse Date String
	{
		...
		{
		    //alert('strMonth : ' + exDateTime.substring(Sp1+1,Sp2));
	...
	//alert(document.getElementById(pCtrl).disabled);
	if(document.getElementById(pCtrl).disabled == false){
	    RenderCal();
	}
}
...
{
    var intmonth=0;
    intmonth=this.Month+1;
	if (this.Format.toUpperCase()=="DDMMYYYY"){
	    //alert(intmonth);
        intmonth=intmonth < 10 ? '0'+intmonth : intmonth;
        pDate=pDate < 10 ? '0'+pDate : pDate;
   		return (pDate+DateSeparator+intmonth+DateSeparator+this.Year);
