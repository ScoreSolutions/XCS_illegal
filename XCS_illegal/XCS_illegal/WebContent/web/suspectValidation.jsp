...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
	...
	frmvalidator.addValidation("update_id","maxlen=22","Max length for UPDATE_ID is 22 ");


	frmvalidator.addValidation("update_id","num","Please Enter number");
	...
	frmvalidator.addValidation("photo_desc","maxlen=500","Max length for PHOTO_DESC is 500 ");


	frmvalidator.addValidation("photo_desc","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("mobile","maxlen=100","Max length for MOBILE is 100 ");
	...
	frmvalidator.addValidation("height","maxlen=22","Max length for HEIGHT is 22 ");


	frmvalidator.addValidation("height","num","Please Enter number");
	...
	frmvalidator.addValidation("suspect_passport","maxlen=20","Max length for SUSPECT_PASSPORT is 20 ");


	frmvalidator.addValidation("suspect_passport","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("suspect_id_card","maxlen=20","Max length for SUSPECT_ID_CARD is 20 ");


	frmvalidator.addValidation("suspect_id_card","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("suspect_type","maxlen=1","Max length for SUSPECT_TYPE is 1 ");

	frmvalidator.addValidation("suspect_type","req","Please Enter SUSPECT_TYPE");

	frmvalidator.addValidation("suspect_type","alnum_s","Please Enter alphabatic");
