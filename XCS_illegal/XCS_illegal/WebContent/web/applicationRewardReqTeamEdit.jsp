...
<form method="post" name="dataform" action="<c:url value="/process2?action=ApplicationRewardReqTeam&cmd=update"/>"            >
	<%@include file="applicationRewardReqTeamForm.jsp"%>
	<input type="hidden" name="id" value="${applicationRewardReqTeam.id}"/>
