...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
	...
	frmvalidator.addValidation("isaccept","req","Please Enter ISACCEPT");

	frmvalidator.addValidation("isaccept","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("offcode_director","maxlen=6","Max length for OFFCODE_DIRECTOR is 6 ");


	frmvalidator.addValidation("offcode_director","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("poscode_director","maxlen=20","Max length for POSCODE_DIRECTOR is 20 ");


	frmvalidator.addValidation("poscode_director","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("staff_id_director","maxlen=13","Max length for STAFF_ID_DIRECTOR is 13 ");


	frmvalidator.addValidation("staff_id_director","alnum_s","Please Enter alphabatic");
	...
	frmvalidator.addValidation("director_inform_for","maxlen=200","Max length for DIRECTOR_INFORM_FOR is 200 ");


	frmvalidator.addValidation("director_inform_for","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("director_inform_to","maxlen=200","Max length for DIRECTOR_INFORM_TO is 200 ");


	frmvalidator.addValidation("director_inform_to","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("offcode_lawyer8","maxlen=6","Max length for OFFCODE_LAWYER8 is 6 ");


	frmvalidator.addValidation("offcode_lawyer8","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("poscode_lawyer8","maxlen=20","Max length for POSCODE_LAWYER8 is 20 ");


	frmvalidator.addValidation("poscode_lawyer8","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("staff_id_lawyer8","maxlen=13","Max length for STAFF_ID_LAWYER8 is 13 ");


	frmvalidator.addValidation("staff_id_lawyer8","alnum_s","Please Enter alphabatic");
	...
	frmvalidator.addValidation("lawyer8_inform_for","maxlen=200","Max length for LAWYER8_INFORM_FOR is 200 ");


	frmvalidator.addValidation("lawyer8_inform_for","alnum_s","Please Enter alphabatic");

	
	frmvalidator.addValidation("lawyer8_inform_to","maxlen=200","Max length for LAWYER8_INFORM_TO is 200 ");


	frmvalidator.addValidation("lawyer8_inform_to","alnum_s","Please Enter alphabatic");
