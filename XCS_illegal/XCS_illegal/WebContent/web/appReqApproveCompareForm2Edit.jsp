...
<form method="post" name="dataform" action="<c:url value="/process2?action=AppReqApproveCompareForm2&cmd=update"/>"                                >
	<%@include file="appReqApproveCompareForm2Form.jsp"%>
	<input type="hidden" name="id" value="${appReqApproveCompareForm2.id}"/>
