...
<HEAD>
    ...
    <script>
        ...
        function initValue(flag) {
            if(flag){
                writeTranLog('ยกเลิกการแก้ไขรายชื่อผู้เกี่ยวข้องกับผู้กระทำผิด');
            }
        <c:if test="${sr!=null}">
//            jQuery("[name=tel_no]").val(opener.document.dataform.lawbreaker_address_tel_no[row].value);
...
//        'lawbreaker_relative_id':data["id"]
            if(maxRow > 1){
            jQuery("[name=relatioin] option[value="+opener.document.dataform.lawbreaker_relative_relation[row].value+"]").attr("selected", "selected");
            jQuery("[name=idcardno]").val(opener.document.dataform.lawbreaker_relative_idcardno[row].value);
            jQuery("[name=title_code] otpion[value="+opener.document.dataform.lawbreaker_relative_title_code[row].value+"]").attr("selected", "selected");
            jQuery("[name=first_name]").val(opener.document.dataform.lawbreaker_relative_first_name[row].value);
            jQuery("[name=last_name]").val(opener.document.dataform.lawbreaker_relative_last_name[row].value);
            jQuery("[name=tel_no]").val(opener.document.dataform.lawbreaker_relative_tel_no[row].value);
            jQuery("[name=email]").val(opener.document.dataform.lawbreaker_relative_email[row].value);
            jQuery("[name=current_address_no]").val(opener.document.dataform.lawbreaker_relative_current_address_no[row].value);
            jQuery("[name=current_moo]").val(opener.document.dataform.lawbreaker_relative_current_moo[row].value);
            jQuery("[name=current_soi]").val(opener.document.dataform.lawbreaker_relative_current_soi[row].value);
            jQuery("[name=current_road]").val(opener.document.dataform.lawbreaker_relative_current_road[row].value);
            jQuery("[name=hometown_address_no]").val(opener.document.dataform.lawbreaker_relative_hometown_address_no[row].value);
            jQuery("[name=hometown_moo]").val(opener.document.dataform.lawbreaker_relative_hometown_moo[row].value);
            jQuery("[name=hometown_soi]").val(opener.document.dataform.lawbreaker_relative_hometown_soi[row].value);
            jQuery("[name=hometown_road]").val(opener.document.dataform.lawbreaker_relative_hometown_road[row].value);
            getProvince('sProvince', 'sDistrict', 'sSubDistrict',opener.document.dataform.lawbreaker_relative_current_province_code[row].value, opener.document.dataform.lawbreaker_relative_current_district_code[row].value,opener.document.dataform.lawbreaker_relative_current_subdistrict_code[row].value);
            getProvince('hsProvince', 'hsDistrict', 'hsSubDistrict',opener.document.dataform.lawbreaker_relative_hometown_province_code[row].value,opener.document.dataform.lawbreaker_relative_hometown_district_code[row].value, opener.document.dataform.lawbreaker_relative_hometown_subdistrict_code[row].value);
            jQuery("[name=id]").val(opener.document.dataform.lawbreaker_relative_id[row].value);
            }else{
            jQuery("[name=relatioin] option[value="+opener.document.dataform.lawbreaker_relative_relation.value+"]").attr("selected", "selected");
            jQuery("[name=idcardno]").val(opener.document.dataform.lawbreaker_relative_idcardno.value);
            jQuery("[name=title_code] otpion[value="+opener.document.dataform.lawbreaker_relative_title_code.value+"]").attr("selected", "selected");
            jQuery("[name=first_name]").val(opener.document.dataform.lawbreaker_relative_first_name.value);
            jQuery("[name=last_name]").val(opener.document.dataform.lawbreaker_relative_last_name.value);
            jQuery("[name=tel_no]").val(opener.document.dataform.lawbreaker_relative_tel_no.value);
            jQuery("[name=email]").val(opener.document.dataform.lawbreaker_relative_email.value);
            jQuery("[name=current_address_no]").val(opener.document.dataform.lawbreaker_relative_current_address_no.value);
            jQuery("[name=current_moo]").val(opener.document.dataform.lawbreaker_relative_current_moo.value);
            jQuery("[name=current_soi]").val(opener.document.dataform.lawbreaker_relative_current_soi.value);
            jQuery("[name=current_road]").val(opener.document.dataform.lawbreaker_relative_current_road.value);
            jQuery("[name=hometown_address_no]").val(opener.document.dataform.lawbreaker_relative_hometown_address_no.value);
            jQuery("[name=hometown_moo]").val(opener.document.dataform.lawbreaker_relative_hometown_moo.value);
            jQuery("[name=hometown_soi]").val(opener.document.dataform.lawbreaker_relative_hometown_soi.value);
            jQuery("[name=hometown_road]").val(opener.document.dataform.lawbreaker_relative_hometown_road.value);
            getProvince('sProvince', 'sDistrict', 'sSubDistrict',opener.document.dataform.lawbreaker_relative_current_province_code.value, opener.document.dataform.lawbreaker_relative_current_district_code.value,opener.document.dataform.lawbreaker_relative_current_subdistrict_code.value);
            getProvince('hsProvince', 'hsDistrict', 'hsSubDistrict',opener.document.dataform.lawbreaker_relative_hometown_province_code.value,opener.document.dataform.lawbreaker_relative_hometown_district_code.value, opener.document.dataform.lawbreaker_relative_hometown_subdistrict_code.value);
            jQuery("[name=id]").val(opener.document.dataform.lawbreaker_relative_id.value);
            }
        </c:if>
        <c:if test="${sr == null}">
        ...
        function appendRow() {
            if (checkValidate()) {
                writeTranLog('บันทึกผู้เกี่ยวข้องกับผู้กระทำผิด');
            var data = [];
            <c:if test="${sr != null}">
                data["id"] = '${sr.id}';
            </c:if>
            ...
            data["current_address"] =
            	(data["current_address_no"] ? " เลขที่ " + data["current_address_no"] : "") +
				(data["current_moo"] ? " หมู่ " + data["current_moo"] : "") +
				(data["current_subdistrict_text"] != "โปรดเลือก" ? " ตำบล" + data["current_subdistrict_text"] : "") +
				(data["current_district_text"] != "โปรดเลือก" ? " อำเภอ" + data["current_district_text"] : "") +
				(data["current_province_text"] != "โปรดเลือก" ? " จังหวัด" + data["current_province_text"] : "");
            ...
            data["hometown_address"] =
		            	(data["hometown_address_no"] ? " เลขที่ " + data["hometown_address_no"] : "") +
						(data["hometown_moo"] ? " หมู่ " + data["hometown_moo"] : "") +
						(data["hometown_subdistrict_text"] != "โปรดเลือก" ? " ตำบล" + data["hometown_subdistrict_text"] : "") +
						(data["hometown_district_text"] != "โปรดเลือก" ? " อำเภอ" + data["hometown_district_text"] : "") +
						(data["hometown_province_text"] != "โปรดเลือก" ? " จังหวัด" + data["hometown_province_text"] : "");
        ...
        function close_form(){
            writeTranLog('ปิดหน้าจอเพิ่มรายชื่อผู้เกี่ยวข้องกับผู้กระทำผิด')
            window.close();
        }
...
<form id="relative_form">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="95%">
        <c:if test="${sr != null}">
            ...
            <input type="hidden" name="lawbreaker_no" value="${sr.lawbreaker_no}" />
        </c:if>
        <c:if test="${sr == null}">
            <input type="hidden" name="lawbreaker_no" value="${lawbreaker_no}" />
        </c:if>
        <tr>
