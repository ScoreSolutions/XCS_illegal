...
function clear2(){
	window.location.href="process?action=ExhibitSell&menu=true";
}
</script>
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td height="25">&nbsp;</td>
				<td><a href="process?action=ExhibitSell&cmd=create" class="linkmenu3level">เพิ่มข้อมูล</a></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>
				<form action="process?action=ExhibitSell&cmd=list&search=true" name="exhibit_form" method="post">				
							...
							<tr>
								...
								<table width="99%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="46%" align="right">เลขที่เอกสาร กค. :&nbsp;${params}</td>
			...
			<tr>
				...
				<table class="tableList" width="650" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
					...
					<tr>
						...
						<td class="TblRow AlignLeft"><a href="process?action=ExhibitSell&cmd=edit&id=${so.id}&display=true">${so.stockout_code}</a></td>
