...
public class BaseAppReqApproveCompareForm2 extends BaseDomain{
	// table
	public static final String TABLE_NAME = "APP_REQ_APPROVE_COMPARE_FORM2";
	public static String SEQUENCE_NAME = TABLE_NAME+"_SEQ";
	//public String viewName ="";

	// pk
	public static final String pkCol = "ID";
	public static final String pkColumn = "APP_REQ_APPROVE_COMPARE_FORM2.ID";
	...
	// full column name
	public static final String UPDATE_ONColumn = "APP_REQ_APPROVE_COMPARE_FORM2.UPDATE_ON";

	public static final String UPDATE_BYColumn = "APP_REQ_APPROVE_COMPARE_FORM2.UPDATE_BY";

	public static final String CREATE_ONColumn = "APP_REQ_APPROVE_COMPARE_FORM2.CREATE_ON";

	public static final String CREATE_BYColumn = "APP_REQ_APPROVE_COMPARE_FORM2.CREATE_BY";

	public static final String OFFCODE_APPROVEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.OFFCODE_APPROVE";

	public static final String POSCODE_APPROVEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.POSCODE_APPROVE";

	public static final String STAFF_ID_APPROVEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.STAFF_ID_APPROVE";

	public static final String APPROVE_DATEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.APPROVE_DATE";

	public static final String NONEAPPROVE_DESCColumn = "APP_REQ_APPROVE_COMPARE_FORM2.NONEAPPROVE_DESC";

	public static final String APPROVE_DESCColumn = "APP_REQ_APPROVE_COMPARE_FORM2.APPROVE_DESC";

	public static final String ISAPPROVEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.ISAPPROVE";

	public static final String OFFCODE_ACCEPTColumn = "APP_REQ_APPROVE_COMPARE_FORM2.OFFCODE_ACCEPT";

	public static final String POSCODE_ACCEPTColumn = "APP_REQ_APPROVE_COMPARE_FORM2.POSCODE_ACCEPT";

	public static final String STAFF_ID_ACCEPTColumn = "APP_REQ_APPROVE_COMPARE_FORM2.STAFF_ID_ACCEPT";

	public static final String NONEACCEPT_DESCColumn = "APP_REQ_APPROVE_COMPARE_FORM2.NONEACCEPT_DESC";

	public static final String ACCEPT_DESCColumn = "APP_REQ_APPROVE_COMPARE_FORM2.ACCEPT_DESC";

	public static final String ISACCEPTColumn = "APP_REQ_APPROVE_COMPARE_FORM2.ISACCEPT";

	public static final String OFFCODE_DIRECTORColumn = "APP_REQ_APPROVE_COMPARE_FORM2.OFFCODE_DIRECTOR";

	public static final String POSCODE_DIRECTORColumn = "APP_REQ_APPROVE_COMPARE_FORM2.POSCODE_DIRECTOR";

	public static final String STAFF_ID_DIRECTORColumn = "APP_REQ_APPROVE_COMPARE_FORM2.STAFF_ID_DIRECTOR";

	public static final String DIRECTOR_INFORM_DATEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.DIRECTOR_INFORM_DATE";

	public static final String DIRECTOR_INFORM_FORColumn = "APP_REQ_APPROVE_COMPARE_FORM2.DIRECTOR_INFORM_FOR";

	public static final String DIRECTOR_INFORM_TOColumn = "APP_REQ_APPROVE_COMPARE_FORM2.DIRECTOR_INFORM_TO";

	public static final String OFFCODE_INFORMColumn = "APP_REQ_APPROVE_COMPARE_FORM2.OFFCODE_INFORM";

	public static final String POSCODE_INFORMColumn = "APP_REQ_APPROVE_COMPARE_FORM2.POSCODE_INFORM";

	public static final String STAFF_ID_INFORMColumn = "APP_REQ_APPROVE_COMPARE_FORM2.STAFF_ID_INFORM";

	public static final String INFORM_DATEColumn = "APP_REQ_APPROVE_COMPARE_FORM2.INFORM_DATE";

	public static final String INFORM_FORColumn = "APP_REQ_APPROVE_COMPARE_FORM2.INFORM_FOR";

	public static final String INFORM_TOColumn = "APP_REQ_APPROVE_COMPARE_FORM2.INFORM_TO";

	public static final String APP_REQ_APPROVE_COMPARE_IDColumn = "APP_REQ_APPROVE_COMPARE_FORM2.APP_REQ_APPROVE_COMPARE_ID";

	public static final String IDColumn = "APP_REQ_APPROVE_COMPARE_FORM2.ID";


	public static final String[] ALL_COLUMNS =
    {
	 UPDATE_ONCol	, UPDATE_BYCol	, CREATE_ONCol	, CREATE_BYCol	, OFFCODE_APPROVECol	, POSCODE_APPROVECol	, STAFF_ID_APPROVECol	, APPROVE_DATECol	, NONEAPPROVE_DESCCol	, APPROVE_DESCCol	, ISAPPROVECol	, OFFCODE_ACCEPTCol	, POSCODE_ACCEPTCol	, STAFF_ID_ACCEPTCol	, NONEACCEPT_DESCCol	, ACCEPT_DESCCol	, ISACCEPTCol	, OFFCODE_DIRECTORCol	, POSCODE_DIRECTORCol	, STAFF_ID_DIRECTORCol	, DIRECTOR_INFORM_DATECol	, DIRECTOR_INFORM_FORCol	, DIRECTOR_INFORM_TOCol	, OFFCODE_INFORMCol	, POSCODE_INFORMCol	, STAFF_ID_INFORMCol	, INFORM_DATECol	, INFORM_FORCol	, INFORM_TOCol	, APP_REQ_APPROVE_COMPARE_IDCol	, pkCol
    };
	...
	public BaseAppReqApproveCompareForm2(DB db){
		super(db);
	}



public synchronized AppReqApproveCompareForm2 create() throws Exception{
		DB db = this.initDB();
		try{
			String columns = "(";
			String parameter = "(";
			...
			if( prep.executeUpdate() == 1 ){
				...
				if( rs.next() ){
					...
					return (AppReqApproveCompareForm2)this;
				}
			}
	...
	public List<AppReqApproveCompareForm2> createList(List<AppReqApproveCompareForm2> objList)throws Exception{
    	DB db = this.initDB();
    	List<AppReqApproveCompareForm2> resultList = new ArrayList<AppReqApproveCompareForm2>();
    	try{
    		this.beginTx(db);
	...
	public AppReqApproveCompareForm2 findByPk(Long id)throws Exception{
		List<AppReqApproveCompareForm2> resultList = this.findByWhere(pkCol+"=?", id);
		return (resultList.size()>0)?resultList.get(0):null;
	}
	public List<AppReqApproveCompareForm2> findByPks(List<Long> ids)throws Exception{
		List<AppReqApproveCompareForm2> resultList = new ArrayList<AppReqApproveCompareForm2>();
		for( int i=0;i<ids.size();i++ )
			resultList.add(this.findByPk(ids.get(i)));
		return resultList;
	}
	public List<AppReqApproveCompareForm2> findAll()throws Exception{
		return findByWhere(null,null);
	}
	public List<AppReqApproveCompareForm2> findAll(PageUtil pageUtil)throws Exception{
		return findByWhere(null,null,pageUtil);
	}
	public List<AppReqApproveCompareForm2> findByWhere(String where,Object obj)throws Exception{
		return this.findByWhere(where,new Object[]{obj});
	}
	public List<AppReqApproveCompareForm2> findByWhere(String where,Object[] objs)throws Exception{
		return this.findByWhere(where, objs, null);
	}
	public List<AppReqApproveCompareForm2> findByWhere(String where,Object obj,PageUtil pageUtil)throws Exception{
		return findByWhere(where,new Object[]{obj},pageUtil);
	}
	public List<AppReqApproveCompareForm2> findByWhere(String where,Object[] objs,PageUtil pageUtil)throws Exception{
		DB db = this.initDB();
		List<AppReqApproveCompareForm2> resultList = new ArrayList<AppReqApproveCompareForm2>();
		try{
			if( pageUtil == null ){
	...
	public List<AppReqApproveCompareForm2> findByExample(AppReqApproveCompareForm2 instance) throws Exception{
		return findByExample(instance,null);
	}
	public List<AppReqApproveCompareForm2> findByExample(AppReqApproveCompareForm2 instance,PageUtil pageUtil) throws Exception{
		Object value =null;
		List<Object> objList = new ArrayList<Object>();
		String where = " 1=1 ";
	...
	//	**** update  ****
	public AppReqApproveCompareForm2 update()throws Exception{
		DB db = this.initDB();
		try{
			String parameter = "";
			List<Object> objList = new ArrayList<Object>();
	...
	public List<AppReqApproveCompareForm2> updateList(List<AppReqApproveCompareForm2> objList)throws Exception{
		DB db = this.initDB();
		List<AppReqApproveCompareForm2> resultList = new ArrayList<AppReqApproveCompareForm2>();
		try{
			this.beginTx(db);
	...
	public Integer deleteList(List<AppReqApproveCompareForm2> objList)throws Exception {
		DB db = this.initDB();
		try{
			this.beginTx(db);
			int delete =0;
	...
	public AppReqApproveCompareForm2 populate(ResultSet rs)throws Exception{
		AppReqApproveCompareForm2 result = new AppReqApproveCompareForm2(this.db);
    	try {
    		for ( int i=0;i<ALL_COLUMNS.length ; i++ ){
