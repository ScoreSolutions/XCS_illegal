...
public class BaseSuspectRelatif extends BaseDomain{
	// table
	public static final String TABLE_NAME = "SUSPECT_RELATIVES";
	public static String SEQUENCE_NAME = TABLE_NAME+"_SEQ";
	//public String viewName ="";

	// pk
	public static final String pkCol = "ID";
	public static final String pkColumn = "SUSPECT_RELATIVES.ID";
	...
	// full column name
	public static final String IDCARDNOColumn = "SUSPECT_RELATIVES.IDCARDNO";

	public static final String UPDATE_ONColumn = "SUSPECT_RELATIVES.UPDATE_ON";

	public static final String UPDATE_BYColumn = "SUSPECT_RELATIVES.UPDATE_BY";

	public static final String CREATE_ONColumn = "SUSPECT_RELATIVES.CREATE_ON";

	public static final String CREATE_BYColumn = "SUSPECT_RELATIVES.CREATE_BY";

	public static final String EMAILColumn = "SUSPECT_RELATIVES.EMAIL";

	public static final String TELColumn = "SUSPECT_RELATIVES.TEL";

	public static final String HOMETOWN_POST_CODEColumn = "SUSPECT_RELATIVES.HOMETOWN_POST_CODE";

	public static final String HOMETOWN_PROVINCE_CODEColumn = "SUSPECT_RELATIVES.HOMETOWN_PROVINCE_CODE";

	public static final String HOMETOWN_DISTRICT_CODEColumn = "SUSPECT_RELATIVES.HOMETOWN_DISTRICT_CODE";

	public static final String HOMETOWN_SUBDISTRICT_CODEColumn = "SUSPECT_RELATIVES.HOMETOWN_SUBDISTRICT_CODE";

	public static final String HOMETOWN_ROADColumn = "SUSPECT_RELATIVES.HOMETOWN_ROAD";

	public static final String HOMETOWN_SOIColumn = "SUSPECT_RELATIVES.HOMETOWN_SOI";

	public static final String HOMETOWN_MOOColumn = "SUSPECT_RELATIVES.HOMETOWN_MOO";

	public static final String HOMETOWN_ADDRESS_NOColumn = "SUSPECT_RELATIVES.HOMETOWN_ADDRESS_NO";

	public static final String CURRENT_POST_CODEColumn = "SUSPECT_RELATIVES.CURRENT_POST_CODE";

	public static final String CURRENT_PROVINCE_CODEColumn = "SUSPECT_RELATIVES.CURRENT_PROVINCE_CODE";

	public static final String CURRENT_DISTRICT_CODEColumn = "SUSPECT_RELATIVES.CURRENT_DISTRICT_CODE";

	public static final String CURRENT_SUBDISTRICT_CODEColumn = "SUSPECT_RELATIVES.CURRENT_SUBDISTRICT_CODE";

	public static final String CURRENT_ROADColumn = "SUSPECT_RELATIVES.CURRENT_ROAD";

	public static final String CURRENT_SOIColumn = "SUSPECT_RELATIVES.CURRENT_SOI";

	public static final String CURRENT_MOOColumn = "SUSPECT_RELATIVES.CURRENT_MOO";

	public static final String CURRENT_ADDRESS_NOColumn = "SUSPECT_RELATIVES.CURRENT_ADDRESS_NO";

	public static final String RELATIONColumn = "SUSPECT_RELATIVES.RELATION";

	public static final String LAST_NAMEColumn = "SUSPECT_RELATIVES.LAST_NAME";

	public static final String FIRST_NAMEColumn = "SUSPECT_RELATIVES.FIRST_NAME";

	public static final String TITLE_CODEColumn = "SUSPECT_RELATIVES.TITLE_CODE";

	public static final String SUSPECT_NOColumn = "SUSPECT_RELATIVES.SUSPECT_NO";

	public static final String IDColumn = "SUSPECT_RELATIVES.ID";


	public static final String[] ALL_COLUMNS =
    {
	 IDCARDNOCol	, UPDATE_ONCol	, UPDATE_BYCol	, CREATE_ONCol	, CREATE_BYCol	, EMAILCol	, TELCol	, HOMETOWN_POST_CODECol	, HOMETOWN_PROVINCE_CODECol	, HOMETOWN_DISTRICT_CODECol	, HOMETOWN_SUBDISTRICT_CODECol	, HOMETOWN_ROADCol	, HOMETOWN_SOICol	, HOMETOWN_MOOCol	, HOMETOWN_ADDRESS_NOCol	, CURRENT_POST_CODECol	, CURRENT_PROVINCE_CODECol	, CURRENT_DISTRICT_CODECol	, CURRENT_SUBDISTRICT_CODECol	, CURRENT_ROADCol	, CURRENT_SOICol	, CURRENT_MOOCol	, CURRENT_ADDRESS_NOCol	, RELATIONCol	, LAST_NAMECol	, FIRST_NAMECol	, TITLE_CODECol	, SUSPECT_NOCol	, pkCol
    };

	public static final String ALL_COLUMN_STRING =  IDCARDNOCol	+","+ UPDATE_ONCol	+","+ UPDATE_BYCol	+","+ CREATE_ONCol	+","+ CREATE_BYCol	+","+ EMAILCol	+","+ TELCol	+","+ HOMETOWN_POST_CODECol	+","+ HOMETOWN_PROVINCE_CODECol	+","+ HOMETOWN_DISTRICT_CODECol	+","+ HOMETOWN_SUBDISTRICT_CODECol	+","+ HOMETOWN_ROADCol	+","+ HOMETOWN_SOICol	+","+ HOMETOWN_MOOCol	+","+ HOMETOWN_ADDRESS_NOCol	+","+ CURRENT_POST_CODECol	+","+ CURRENT_PROVINCE_CODECol	+","+ CURRENT_DISTRICT_CODECol	+","+ CURRENT_SUBDISTRICT_CODECol	+","+ CURRENT_ROADCol	+","+ CURRENT_SOICol	+","+ CURRENT_MOOCol	+","+ CURRENT_ADDRESS_NOCol	+","+ RELATIONCol	+","+ LAST_NAMECol	+","+ FIRST_NAMECol	+","+ TITLE_CODECol	+","+ SUSPECT_NOCol	+","+ pkCol	;
    ...
    //public static final String SQL_UPDATE = " update "+TABLE_NAME+" set "+IDCARDNOCol+"=?,"+UPDATE_ONCol+"=?,"+UPDATE_BYCol+"=?,"+CREATE_ONCol+"=?,"+CREATE_BYCol+"=?,"+EMAILCol+"=?,"+TELCol+"=?,"+HOMETOWN_POST_CODECol+"=?,"+HOMETOWN_PROVINCE_CODECol+"=?,"+HOMETOWN_DISTRICT_CODECol+"=?,"+HOMETOWN_SUBDISTRICT_CODECol+"=?,"+HOMETOWN_ROADCol+"=?,"+HOMETOWN_SOICol+"=?,"+HOMETOWN_MOOCol+"=?,"+HOMETOWN_ADDRESS_NOCol+"=?,"+CURRENT_POST_CODECol+"=?,"+CURRENT_PROVINCE_CODECol+"=?,"+CURRENT_DISTRICT_CODECol+"=?,"+CURRENT_SUBDISTRICT_CODECol+"=?,"+CURRENT_ROADCol+"=?,"+CURRENT_SOICol+"=?,"+CURRENT_MOOCol+"=?,"+CURRENT_ADDRESS_NOCol+"=?,"+RELATIONCol+"=?,"+LAST_NAMECol+"=?,"+FIRST_NAMECol+"=?,"+TITLE_CODECol+"=?,"+SUSPECT_NOCol+"=?";
	public static final String SQL_UPDATE = " update "+TABLE_NAME+" set ";

	//**** constructor ****
	
	public BaseSuspectRelatif(DB db){
		super(db);
	}



public synchronized SuspectRelatif create() throws Exception{
		DB db = this.initDB();
		try{
			String columns = "(";
			String parameter = "(";
	...
	public List<SuspectRelatif> createList(List<SuspectRelatif> objList)throws Exception{
    	DB db = this.initDB();
    	List<SuspectRelatif> resultList = new ArrayList<SuspectRelatif>();
    	try{
    		this.beginTx(db);
	...
	public SuspectRelatif findByPk(Long id)throws Exception{
		List<SuspectRelatif> resultList = this.findByWhere(pkCol+"=?", id);
		return (resultList.size()>0)?resultList.get(0):null;
	}
	public List<SuspectRelatif> findByPks(List<Long> ids)throws Exception{
		List<SuspectRelatif> resultList = new ArrayList<SuspectRelatif>();
		for( int i=0;i<ids.size();i++ )
			resultList.add(this.findByPk(ids.get(i)));
		return resultList;
	}
	public List<SuspectRelatif> findAll()throws Exception{
		return findByWhere(null,null);
	}
	public List<SuspectRelatif> findAll(PageUtil pageUtil)throws Exception{
		return findByWhere(null,null,pageUtil);
	}
	public List<SuspectRelatif> findByWhere(String where,Object obj)throws Exception{
		return this.findByWhere(where,new Object[]{obj});
	}
	public List<SuspectRelatif> findByWhere(String where,Object[] objs)throws Exception{
		return this.findByWhere(where, objs, null);
	}
	public List<SuspectRelatif> findByWhere(String where,Object obj,PageUtil pageUtil)throws Exception{
		return findByWhere(where,new Object[]{obj},pageUtil);
	}
	public List<SuspectRelatif> findByWhere(String where,Object[] objs,PageUtil pageUtil)throws Exception{
		DB db = this.initDB();
		List<SuspectRelatif> resultList = new ArrayList<SuspectRelatif>();
		try{
			if( pageUtil == null ){
	...
	public List<SuspectRelatif> findByExample(SuspectRelatif instance) throws Exception{
		return findByExample(instance,null);
	}
	public List<SuspectRelatif> findByExample(SuspectRelatif instance,PageUtil pageUtil) throws Exception{
		Object value =null;
		List<Object> objList = new ArrayList<Object>();
		String where = " 1=1 ";
	...
	//	**** update  ****
	public SuspectRelatif update()throws Exception{
		DB db = this.initDB();
		try{
			String parameter = "";
			List<Object> objList = new ArrayList<Object>();
	...
	public List<SuspectRelatif> updateList(List<SuspectRelatif> objList)throws Exception{
		DB db = this.initDB();
		List<SuspectRelatif> resultList = new ArrayList<SuspectRelatif>();
		try{
			this.beginTx(db);
	...
	public Integer deleteList(List<SuspectRelatif> objList)throws Exception {
		DB db = this.initDB();
		try{
			this.beginTx(db);
			int delete =0;
	...
	public SuspectRelatif populate(ResultSet rs)throws Exception{
		SuspectRelatif result = new SuspectRelatif(this.db);
    	try {
    		for ( int i=0;i<ALL_COLUMNS.length ; i++ ){
