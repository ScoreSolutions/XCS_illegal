...
public class Constants {
	...
	public static final String ACCUSER_TYPE_DEPT = "3";   //เจ้าหน้าที่สรรพสามิตภาค
	public static final String ACCUSER_TYPE_AREA = "1";   //เจ้าหน้าที่สรรพสามิตพื้นที่
	public static final String ACCUSER_TYPE_BRANCH = "4"; //เจ้าหน้าที่สรรพสามิตพื้นที่สาขา 
	public static final String ACCUSER_TYPE_XCS = "2";    //เจ้าหน้าที่สรรพสามิตกรมสรรพสามิต

	public static final String OFFCODE_TYPE_DEPT = "D";   //ภาค
	public static final String OFFCODE_TYPE_AREA = "E";   //พื้นที่
	public static final String OFFCODE_TYPE_BRANCH = "F";  //พื้นที่สาขา
