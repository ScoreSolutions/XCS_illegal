 ...
 */
            ...
            /**
            *  TambolInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TambolInfo
    ...
    public static class Factory{
        ...
        */
        public static TambolInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TambolInfo object =
                new TambolInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TambolInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TambolInfo)com.pccth.rdbservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
