...
<script language="javascript">
	...
	var unit_desc='';
	var action_form =  'ExhibitKeep';
	var module_name = 'การจัดเก็บของกลางเข้าพิพิธภัณฑ์';
	var so_id = '${so.id}';
...
<form action="process?action=ExhibitKeep&cmd=update" name="formdata1" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="1%">&nbsp;</td>
				<td width="99%"><span class="websitename">การจัดเก็บของกลางเข้าพิพิธภัณฑ์</span></td>
			</tr>
			<tr>
				<td height="25">&nbsp;</td>
				<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									...
									<input type="text" name="stockout_code2" class="textbox" size="5" maxlength="9" value="${so.stockoutCode2}" /> <font style="color: red">*</font>
								</td>
								...
								<td>
									...
									<a href="javascript:NewCssCal('stockout_date','ddmmyyyy')"><img src="images/btn_calendar.png" alt="" width="19" height="19" align="middle" style="border-style: none"></a> <font style="color: red">*</font>
								</td>
							</tr>
							<tr>
								<td width="19%" height="25" align="right">เรื่อง :&nbsp;</td>
								<td width="25%"><input type="text" name=subject class="textbox" value="${so.subject}"> <font style="color: red">*</font></td>
								<td align="right">เรียน :&nbsp;</td>
								<td>
									<input type="hidden" name="report_to_staff" id="report_to_staff" value="${so.report_to_staff}"> 								    
								    <input type="hidden" name="staff_name" id="staff_name" class="textview" size="25" value="${staff_name}" readonly >
							...
							<tr>
								...
								<td height="25" colspan="3" ><select name="legislation_id" style="width: 250">
				...
				<tr>
					...
					<table id="exhibit_table" class="tableList" width="1000" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
						<tr>
							...
							<td width="10%" class="TblHeaderColumn AlignCenter">จำนวนที่จัดเก็บของกลาง</td>
						...
						<tr>
							...
							<td><div align='center'>${soi.sizes_desc} ${soi.sizes_unit_name}
							...
							<td>
								<div >
									<input type='text' name='netweight' size='5' value='${soi.netweight}' class='textNum' OnKeyPress='ChkMinusDbl(this);' />
						...
						<tr>
							<td colspan="7" align="right"><b><u>รวมจำนวนที่จัดเก็บของกลาง :&nbsp;</u></b></td>
							<td align="right"><span id="total">${qty} ${unit_desc}</span></td>
							<td colspan="2">&nbsp;</td>
						</tr>
					</table>
					</td>
