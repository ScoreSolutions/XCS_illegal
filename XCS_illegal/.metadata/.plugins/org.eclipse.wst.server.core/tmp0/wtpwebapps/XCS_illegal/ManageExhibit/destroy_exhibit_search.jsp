...
function clear2(){
	window.location.href="process?action=ExhibitDestroy&menu=true";
}
</script>
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td height="25">&nbsp;</td>
				<td><a href="process?action=ExhibitDestroy&cmd=create" class="linkmenu3level">เพิ่มข้อมูล</a></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>
				<form action="process?action=ExhibitDestroy&cmd=list" name="exhibit_form" method="post">
							...
							<tr>
								...
								<table width="99%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="46%" align="right">เลขที่เอกสาร กค. :&nbsp;</td>
									...
									<tr>
										<td align="right">&nbsp;</td>
										<td align="right">&nbsp;</td>
										<td height="25"><input alt="Submit Form" type="image" src="images/btn_search_big.png" width="64" height="22" name="search"><%@ include file="../Templates/clearIcon.jsp"%></td>
									</tr>
								</table>
								</td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td align="left">
											<select name="so_status" id="so_status" style="width: 250">
												<option value="" selected>ทั้งหมด</option>
												<option value="1" <c:if test="${so_status == '1'}">selected</c:if> >ทำรายการ</option>
												<option value="2" <c:if test="${so_status == '2'}">selected</c:if> >ยืนยันการทำลาย</option>
											</select>
										</td>
									</tr>
								</table>
			...
			<tr>
				...
				<table class="tableList" width="650" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
					...
					<tr>
						...
						<td class="TblRow AlignLeft"><a href="process?action=ExhibitDestroy&cmd=edit&id=${so.id}&display=true">${so.stockout_code}</a></td>
