...
function clear2(){
	window.location.href="process?action=ExhibitKeep&menu=true";
}
</script>
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td height="25">&nbsp;</td>
				<td><a href="process?action=ExhibitKeep&cmd=create" class="linkmenu3level">เพิ่มข้อมูล</a></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>
				<form action="process?action=ExhibitKeep&cmd=list" name="exhibit_form" method="post">
							...
							<tr>
								...
								<table width="99%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td height="25"><select name="legislation_id" style="width: 250">
			...
			<tr>
				...
				<table class="tableList" width="650" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
					...
					<tr>
						...
						<td class="TblRow AlignLeft"><a href="process?action=ExhibitKeep&cmd=edit&id=${so.id}&display=true">${so.stockout_code}</a></td>
