...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
	...
	frmvalidator.addValidation("application_arrest_exhibit_id","maxlen=10","Max length for APPLICATION_ARREST_EXHIBIT_ID is 10 ");


	frmvalidator.addValidation("application_arrest_exhibit_id","alnum_s","Please Enter alphabatic");
	...
	frmvalidator.addValidation("isdomestic","maxlen=10","Max length for ISDOMESTIC is 10 ");
	...
	frmvalidator.addValidation("isexhibitco","maxlen=1","Max length for ISEXHIBITCO is 1 ");

	frmvalidator.addValidation("isexhibitco","req","Please Enter ISEXHIBITCO");

	frmvalidator.addValidation("isexhibitco","alnum_s","Please Enter alphabatic");
