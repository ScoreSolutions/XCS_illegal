...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
	...
	frmvalidator.addValidation("money2","maxlen=22","Max length for MONEY2 is 22 ");

	frmvalidator.addValidation("money2","req","Please Enter MONEY2");

	frmvalidator.addValidation("money2","num","Please Enter number");

	
	frmvalidator.addValidation("money1","maxlen=22","Max length for MONEY1 is 22 ");

	frmvalidator.addValidation("money1","req","Please Enter MONEY1");

	frmvalidator.addValidation("money1","num","Please Enter number");
	...
	frmvalidator.addValidation("share1","maxlen=22","Max length for SHARE1 is 22 ");

	frmvalidator.addValidation("share1","req","Please Enter SHARE1");

	frmvalidator.addValidation("share1","num","Please Enter number");
	...
	frmvalidator.addValidation("title_code","req","Please Enter TITLE_CODE");
