...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
	...
	frmvalidator.addValidation("ref_stockout_id","maxlen=22","Max length for REF_STOCKOUT_ID is 22 ");


	frmvalidator.addValidation("ref_stockout_id","num","Please Enter number");
	...
	frmvalidator.addValidation("stockout_id","req","Please Enter STOCKOUT_ID");
