...
<form method="post" name="dataform" action="<c:url value="/process2?action=RewardDivideAlcohol&cmd=update"/>"                   >
	<%@include file="rewardDivideAlcoholForm.jsp"%>
	<input type="hidden" name="id" value="${rewardDivideAlcohol.id}"/>
