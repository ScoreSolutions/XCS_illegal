...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("dataform");
	...
	frmvalidator.addValidation("application_invest_id","maxlen=22","Max length for APPLICATION_INVEST_ID is 22 ");

	frmvalidator.addValidation("application_invest_id","req","Please Enter APPLICATION_INVEST_ID");

	frmvalidator.addValidation("application_invest_id","num","Please Enter number");
