...
<form method="post" name="dataform" action="<c:url value='process?action=Divide_staff_popForArrest&formname=${formname}&id=${empid}&posname=${posname}&poscode=${poscode}&offname=${offname}&offcode=${offcode}&actype=${actype}&cmd=list'/>">
