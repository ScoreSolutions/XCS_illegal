...
function clear2(value,empid,posname,poscode,offname,offcode){
	   var type = "${formname}";
...
<BODY>
<form method="post" name="dataform" action="<c:url value='process?action=Divide_staff_pop&formname=${formname}&id=${empid}&posname=${posname}&poscode=${poscode}&offname=${offname}&offcode=${offcode}&actype=${actype}&cmd=list'/>">
<table border="0" cellpadding="0" cellspacing="0" width="95%">
	...
	<tr>
		<td colspan="2">
			<input name="btnSelect"  type="button" class="barButton" value="ไม่เลือกรายการ"  onclick="clear2();" />
	...
	<tr>
		...
		<td width="70%">
            ...
            <option value=${team.inspector_name} >${team.inspector_code} ${team.inspector_name}</option>
            </c:forEach>
            </select>
		</td>
	</tr>
	<tr>
		...
		<td width="70%">
			<input name="txtfname" type="text" class="text"  size="20">
			นามสกุล :&nbsp;&nbsp;&nbsp;<input name="txtlname" type="text" class="text"  size="25">
		</td>
	</tr>
	<tr>
		<td  align="right">ตำแหน่ง : </td>
		<td >
			<input name="txtposname" type="text" class="text"  size="50">
		</td>
	</tr>
	<tr>
		<td  align="right">สังกัด : </td>
		<td >
			<input name="txtoffname" type="text" class="text"  size="50">
		</td>
	</tr>
	<tr>
		<td align="right">&nbsp;</td>
