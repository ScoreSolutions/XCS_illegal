...
<%-- -form method="post" name="dataform" action="<c:url value="/process?action=Invest&cmd=create"/>" enctype="multipart/form-data" --%>
<form method="post" name="dataform" action="<c:url value="/process?action=Invest&cmd=saveData"/>" >
