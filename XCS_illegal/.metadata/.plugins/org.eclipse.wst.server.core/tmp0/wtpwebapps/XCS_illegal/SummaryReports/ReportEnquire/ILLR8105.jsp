...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.5 จำนวนคดี ค่าเปรียบเทียบปรับ สินค้าประเภทน้ำมันและผลิตภัณฑ์น้ำมัน (ข้อมูลโดยรวม)</span></td>
            </tr>
            ...
            <tr style="display:none">
            	...
            	<td>
            		<table width="700" border="0" cellpadding="0" cellspacing="0" >
            			<tr>
							<td align="right" height="40" >ประเภทสินค้า :&nbsp;</td>
							<td height="40" >
								<select name="group_id" id="group_id" style="width:190px;">
...
function report(){
	...
	if(year1 == ""){
		...
		var param = 'process?action=Report&__report=ILLR8105&__formatt=pdf&vYear1='+vYear1+'&vYear2='+vYear2+'&vYear3='+vYear3+'&vOffcode1='+vOffcode1+'&vOffcode2='+vOffcode2+'&vOffcode3='+vOffcode3+'&getUserID='+user_id;
		//alert (param);
