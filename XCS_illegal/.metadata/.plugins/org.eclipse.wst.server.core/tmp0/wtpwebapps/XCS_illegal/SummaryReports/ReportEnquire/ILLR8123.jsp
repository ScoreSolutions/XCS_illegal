...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.23 ตารางแสดงผลการปราบปรามผู้กระทำผิดกฏหมายสรรพสามิต ประจำเดือน</span></td>
            </tr>
...
function report(){
	...
	if(monthfrom == ""){
		...
		var param = 'process?action=Report&__report=ILLR8123&__formatt=pdf&vDateFrom='+datefrom+'&vDateTo='+dateto+'&getUserID='+user_id;
		//alert(param);
