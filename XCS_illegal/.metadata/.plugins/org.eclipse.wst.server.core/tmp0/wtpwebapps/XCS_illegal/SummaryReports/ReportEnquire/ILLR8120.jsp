	...
	<tr>
		<td width="100%"align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 		<tr>
		 			<td width="1%" >&nbsp;</td>
         			<td width="99%"><span class="websitename">1.20 รายละเอียดจำนวนคดี ค่าปรับ และของกลางผู้กระทำผิด พ.ร.บ.ภาษีสรรพสามิต พ.ศ.2527 (น้ำมันและผลิตภัณฑ์น้ำมัน)</span></td>
         		</tr> 
              	...
              	<script type='text/javascript'>
					...
					function report(){
						...
						if(monthto==""||monthfrom==""){
							...
							year1 = year1 - 543;
							var param = 'process?action=Report&__report=ILLR8120&__formatt=pdf&vMonthFrom='+monthfrom+
