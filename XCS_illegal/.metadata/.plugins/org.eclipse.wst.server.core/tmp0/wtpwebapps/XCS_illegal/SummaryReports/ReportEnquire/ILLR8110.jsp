		...
		<td width="100%"align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			 	<tr>
			 		<td width="1%">&nbsp;</td>
	              	<td width="99%">
	              		<span class="websitename">1.10 ผลการปราบปรามผู้กระทำผิดกฎหมายสรรพสามิต (รวมทุกพ.ร.บ.)</span>
	              	</td>
	            </tr> 
	               	...
	               	<td >
	               		<table width="700" border="0" cellspacing="0" cellpadding="0">
	               			...
	               			<tr>
	               				...
	               				<td><input  type="text" name="year1" onkeypress="ChkMinusInt('this');" maxlength="4" id="year1" size="8"></td>
	               			</tr>
	               		</table>
					</td>  
				</tr>				
...
function report(){
	...
	if(monthfrom != "" && monthto != "" && year1 != ""){
  		var param = 'process?action=Report&__report=ILLR8110&__formatt=pdf&getMonthfrom='+datefrom+
