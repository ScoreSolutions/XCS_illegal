	...
	<tr>
		<td width="100%"align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 		<tr>
		 			<td width="1%" >&nbsp;</td>
         			<td width="99%"><span class="websitename">1.19 รายละเอียดจำนวนคดี ค่าปรับ และของกลางผู้กระทำผิด พ.ร.บ.ภาษีสรรพสามิต พ.ศ.2527</span></td>
         		</tr> 
              	...
              	<script type='text/javascript'>
					...
					function report(){
						...
						if(monthto==""||monthfrom==""){
							...
							year1 = year1 - 543;
							var param = 'process?action=Report&__report=ILLR8119&__formatt=pdf&vMonthFrom='+monthfrom+
								'&vMonthTo='+monthto+'&vYear='+year1+'&vOffcode='+sector_code+'&getUserID='+user_id;
							var param1 = 'process?action=Report&__report=ILLR8119_1&__formatt=pdf&vMonthFrom='+monthfrom+
							'&vMonthTo='+monthto+'&vYear='+year1+'&vOffcode='+sector_code+'&getUserID='+user_id;
							var param2 = 'process?action=Report&__report=ILLR8119_2&__formatt=pdf&vMonthFrom='+monthfrom+
							'&vMonthTo='+monthto+'&vYear='+year1+'&vOffcode='+sector_code+'&getUserID='+user_id;
							alert(param);
							
							//window.open(param,'_blank' , 'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
							//window.open(param1,'_blank' , 'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
							//window.open(param2,'_blank' , 'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
