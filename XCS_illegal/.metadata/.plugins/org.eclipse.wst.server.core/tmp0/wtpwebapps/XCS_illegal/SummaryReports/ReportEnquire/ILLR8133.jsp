...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">1.33 ตารางแสดงผลการปราบปรามผู้กระทำผิดกฏหมายสรรพสามิตของ สตป. <br />(ปฏิบัติงานในส่วนกลางและส่วนภูมิภาค)</span></td>
            </tr>
...
function report(){
	...
	if(monthfrom == ""){
		...
		//รายงานที่ ILLR8133 กับ ILLR8132 คือรายงานตัวเดียวกัน
		var param = 'process?action=Report&__report=ILLR8132&__formatt=pdf&vMonth='+monthfrom2+'&vYear='+year1+'&getUserID='+user_id;
		//alert(param);
