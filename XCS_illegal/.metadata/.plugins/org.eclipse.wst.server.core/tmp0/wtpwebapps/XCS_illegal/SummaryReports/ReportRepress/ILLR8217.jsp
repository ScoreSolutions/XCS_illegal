...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		 	<tr>
		 		<td width="1%">&nbsp;</td>
             	<td width="99%"><span class="websitename">2.17 สรุปรายงานผลการปราบปราม ส่วนป้องกันและปราบปราม  <br />สำนักตรวจสอบ ป้องกันและปราบปรามประจำเดือน (แสดงข้อมูลของแต่ละคดี แต่ละพ.ร.บ.)</span></td>
            </tr>
...
function report(){
	...
	if(monthfrom == ""){
		...
		var param = 'process?action=Report&__report=ILLR8217&__formatt=pdf&vMonth='+monthfrom2+'&vYear='+year1+'&getUserID='+user_id;
		//alert(param);
