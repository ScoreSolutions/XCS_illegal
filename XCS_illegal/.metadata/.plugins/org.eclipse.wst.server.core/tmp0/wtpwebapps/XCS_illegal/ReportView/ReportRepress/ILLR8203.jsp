...
<!-- Body -->
	...
	<td width="100%" align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">		
			<tr>
            	<td width="99%" height="40"><span class="header">รายงานการกระทำผิดกฎหมายสรรพสามิต</span></td>
            </tr> 
		...
		<table border="0" style="width: 578px">
			...
			<tr>
				...
				<td><select id="sector_code" name="sector_code" style="width: 350px" onchange="getArea('area_code',this.value),getBranch('branch_code',this.value)"></select></td>
        	</tr>
					...
					function report(){
					 ...
					 var dateto;
						...
						if(compare_case_date==""||compare_case_date1==""){
							...
							if(sector_code==""){
								alert ('process?action=Report&__report=ILLR8203_1&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
								window.open('process?action=Report&__report=ILLR8203_1&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
							}
							else{
								alert ('process?action=Report&__report=ILLR8203&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
								'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
				    			window.open('process?action=Report&__report=ILLR8203&__formatt=pdf&getDatefrom='+datefrom+'&getDateto='+dateto+
								'&getOffcode1='+sector_code+'&getOffcode2='+area_code+'&getOffcode3='+branch_code+'&getLegislationid='+legislation_id, '_blank' ,'menubar=no,toolbar=yes,resizable=yes,location=no,scrollbars=no,width=900,height=700');
   							}
   						}
					}
