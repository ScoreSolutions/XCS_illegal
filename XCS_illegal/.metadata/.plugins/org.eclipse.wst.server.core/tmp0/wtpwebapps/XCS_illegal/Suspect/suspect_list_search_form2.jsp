...
<form action="process?action=Suspect&cmd=list" method="post" name="form1">
    <input type="hidden" name="suspect_type" value="2"/>
    <input type="hidden" name="suspect_type_text" value="_eng"/>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td width="30%"><input type="text"
                                                           name="suspect_passport"
                                                           class="textbox" value="${suspect_passport}"/></td>
                                    <td width="20%" align="right">มาจากประเทศ:&nbsp;</td>
                                    <td width="30%"><input type="text"
                                                           name="country_name"
                                                           class="textbox" value="${country_name}"/></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        ...
                        <td height="40" align="center" valign="bottom">
                            ...
                            <input alt="Submit Form" type="image"
                                   ...
                                   name="search" onclick="writeTranLog('ค้นหาประวัติผู้ต้องสงสัยชาวต่างชาติ');">
