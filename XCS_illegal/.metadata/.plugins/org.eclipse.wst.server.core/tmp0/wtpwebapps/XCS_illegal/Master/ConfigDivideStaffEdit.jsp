...
%>
<form method="post" name="dataform" action="<c:url value="process?action=ConfigDivideStaffList_Master&cmd=edit"/>" >
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="40">
                  <td colspan="2"><input name="btnSave"  type="submit" class="barbutton" value="บันทึก" onClick="return chkSubmit();" />
					              <input name="btnCancel"  type="button" class="barbutton" value="ยกเลิกการแก้ไข" onclick="updateCourt('<c:url value="/process?action=ConfigDivideStaffList_Master&cmd=list&offcode=${off_code}"/>');" >
			      </td>
			    </tr>
                <tr>
					<td>&nbsp;</td>
					<td>
                		...
                		<table border="0" cellpadding="0" cellspacing="0" width="700">
                			<tr height="40">
                				...
                				<td width="50%">
			                        <input type="text" name="offcode" id="offcode" size="4"  class="textbox"  value="${off_code}" onBlur="getOffname(this.value,'Y',offname);" >
								   ...
								   <input type="text" name="offname" id="offname" size="48"  class="textview"  value="${off_name.short_name }" >
