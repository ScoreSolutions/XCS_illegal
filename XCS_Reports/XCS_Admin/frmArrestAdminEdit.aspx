<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmArrestAdminEdit.aspx.vb"
    Inherits="XCS_Admin.frmArrestAdminEdit" enableEventValidation="false"  enableViewStateMac="false" %>
...
<%@ Register src="FormUserControl/ucBookImpeachment.ascx" tagname="ucBookImpeachment" tagprefix="uc9" %>
<%@ Register src="FormUserControl/ucCompareCase.ascx" tagname="ucCompareCase" tagprefix="uc10" %>
<%@ Register src="FormUserControl/ucProveExhibit.ascx" tagname="ucProveExhibit" tagprefix="uc11" %>
<%@ Register src="FormUserControl/ucPayFine.ascx" tagname="ucPayFine" tagprefix="uc12" %>
...
<body>
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButtonList ID="rdLawbreakType" runat="server" RepeatColumns="2" Width="190px" Height="18px">
                                            <asp:ListItem Value="1" Selected="False" >บุคคลทั่วไป </asp:ListItem>
                                            <asp:ListItem Value="2">ผู้ประกอบการ </asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td >
                                        <asp:RadioButtonList ID="rdHaveCluprit" runat="server" RepeatColumns="2" Width="190px"
                                            ...
                                            <asp:ListItem Value="Y" Selected="True" >มีตัว </asp:ListItem>
                                            <asp:ListItem Value="N">ไม่มีตัว </asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                    <td class="style2">
                    ...
                    <tr>
                        ...
                        <td  valign="top">
                            <asp:RadioButtonList ID="rdAccuserType" runat="server" RepeatColumns="2" Width="403px">
                                <asp:ListItem Value="2" Selected="False" >เจ้าหน้าที่กรมสรรพสามิต </asp:ListItem>
                                <asp:ListItem Value="3">เจ้าหน้าที่สรรพสามิตภาค </asp:ListItem>
                                <asp:ListItem Value="1">เจ้าหน้าที่สรรพสามิตพื้นที่ </asp:ListItem>
    ...
    <div id="div5" >
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <cc1:TabContainer ID="TabContainer1" runat="server" AutoPostBack="False" Width="100%"
                    EnableTheming="False" Style="margin-bottom: 49px" ActiveTabIndex="0">
                    <cc1:TabPanel runat="server" HeaderText="TabPanel1" ID="tabImdictment" Width="800px">
                        <HeaderTemplate>
                            <font size="2pt">ข้อกล่าวหา</font></HeaderTemplate>
                        <ContentTemplate>
                            <table cellspacing="1" width="100%">
                                <tr>
                                    <td>
                                        &nbsp;<asp:Button ID="btnAddIndictment" runat="server" Text="เพิ่มใหม่" Width="69px" /><uc5:frmSearchIndictment
                                            ID="frmSearchIndictment1" runat="server" />
                                            ...
                                            <asp:GridView ID="gvIndictment" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ของกลางเถื่อน">
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkExhibitWild" runat="server" /><asp:Label ID="lblExhibitWild"
                                                                runat="server" Text='<%# Bind("Exhibit_Wild") %>' Style="display: none"></asp:Label></ItemTemplate>
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblIndictmentID" runat="server" Text='<%# Bind("INDICTMENT_ID") %>'
                                                                Style="display: none"></asp:Label></ItemTemplate>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="tabLawbreakerList" ID="tabLawbreakerList">
                        <HeaderTemplate>
                            <font size="2pt">รายชื่อผู้กระทำผิดกฏหมาย</font></HeaderTemplate>
                        <ContentTemplate>
                            <table cellspacing="1" width="100%">
                                <tr>
                                    <td>
                                        &nbsp;<asp:Button ID="btnAddArrestLawbreaker" runat="server" Text="เพิ่มใหม่" Width="69px" /><uc6:frmPopArrestLawbreaker
                                            ID="frmPopArrestLawbreaker1" runat="server" />
                                        &nbsp;<asp:Button ID="btnDeleteArrestLawbreaker" runat="server" Text="ลบรายการ" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1">
                                        <div style="width: 100%; height: 200px; overflow-y: scroll;">
                                            <asp:GridView ID="gvArrestLawbreaker" runat="server" AutoGenerateColumns="False"
                                                AllowSorting="true" CssClass="GridViewStyle" Width="98%">
                                                <RowStyle CssClass="RowStyle" />
                                                <Columns>
                                                    <asp:BoundField DataField="seq" HeaderText="ลำดับที่">
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <HeaderTemplate>
                                                            <asp:CheckBox ID="chkH" runat="server" OnCheckedChanged="chkH_OnCheckedChanged" AutoPostBack="true" /></HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chk" runat="server" /><asp:Label ID="lblNationality_ID" runat="server"
                                                                Text='<%# Eval("Nationality_ID") %>' Visible="false"></asp:Label><asp:Label ID="lblRace_ID"
                                                                    runat="server" Text='<%# Eval("Race_ID") %>' Visible="false"></asp:Label><asp:Label
                                                                        ID="lblSubDistrict_Code" runat="server" Text='<%# Eval("SubDistrict") %>' Visible="false"></asp:Label><asp:Label
                                                                            ID="lblDistrict_Code" runat="server" Text='<%# Eval("District") %>' Visible="false"></asp:Label><asp:Label
                                                                                ID="lblProvince_Code" runat="server" Text='<%# Eval("Province") %>' Visible="false"></asp:Label><asp:Label
                                                                                    ID="lblTitle_Code" runat="server" Text='<%# Eval("Title_Code") %>' Visible="false"></asp:Label><asp:Label
                                                                                        ID="lblFirstName" runat="server" Text='<%# Eval("First_NAME") %>' Visible="false"></asp:Label><asp:Label
                                                                                            ID="lblLastName" runat="server" Text='<%# Eval("Last_Name") %>' Visible="false"></asp:Label><asp:Label
                                                                                                ID="lblSex" runat="server" Text='<%# Eval("Sex") %>' Visible="false"></asp:Label><asp:Label
                                                                                                    ID="lblCULPRIT_TYPE" runat="server" Text='<%# Eval("CULPRIT_TYPE") %>' Visible="false"></asp:Label><asp:Label
                                                                                                        ID="lblOtherName" runat="server" Text='<%# Eval("Other_Name") %>' Visible="false"></asp:Label><asp:Label
                                                                                                            ID="lblAddress_no" runat="server" Text='<%# Eval("Address_no") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                ID="lblMoo" runat="server" Text='<%# Eval("Moo") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                    ID="lblSoi" runat="server" Text='<%# Eval("Soi") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                        ID="lblRoad" runat="server" Text='<%# Eval("Road") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                            ID="lblTitle_Name" runat="server" Text='<%# Eval("Title_Name") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                                ID="lblProvince_Name" runat="server" Text='<%# Eval("Province_Name") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                                    ID="lblDistrict_Name" runat="server" Text='<%# Eval("District_Name") %>' Visible="false"></asp:Label><asp:Label
                                                                                                                                        ID="lblSubDistrict_Name" runat="server" Text='<%# Eval("SubDistrict_Name") %>'
                                                                                                                                        Visible="false"></asp:Label><asp:Label ID="lblAge" runat="server" Text='<%# Eval("Age") %>'
                                                                                                                                            Visible="false"></asp:Label><asp:Label ID="lblMIDDLE_NAME" runat="server" Text='<%# Eval("MIDDLE_NAME") %>'
                                                                                                                                                Visible="false"></asp:Label><asp:Label ID="lblEXCISE_REG_NO" runat="server" Text='<%# Eval("EXCISE_REG_NO") %>'
                                                                                                                                                    Visible="false"></asp:Label><asp:Label ID="lblCORPORATION_CODE" runat="server" Text='<%# Eval("CORPORATION_CODE") %>'
                                                                                                                                                        Visible="false"></asp:Label><asp:Label ID="lblCOMPANY_NAME" runat="server" Text='<%# Eval("COMPANY_NAME") %>'
                                                                                                                                                            Visible="false"></asp:Label><asp:Label ID="lblCOMPANY_TITLE_CODE" runat="server"
                                                                                                                                                                Text='<%# Eval("COMPANY_TITLE_CODE") %>' Visible="false"></asp:Label></ItemTemplate>
                                                        <HeaderStyle Width="30px" />
                                                        <ItemStyle HorizontalAlign="Center" Width="30px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ชื่อผู้กระทำผิด">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnk_fullname" runat="server" CommandName="Edit" CommandArgument='<%# Eval("seq")%>'
                                                                Text='<%# Eval("Title_Name") + Eval("First_NAME") + " " + Eval("Last_Name")  %>'></asp:LinkButton></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="150px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ประเภทผู้กระทำผิด">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCULPRIT" runat="server" Text='<%# Eval("CULPRIT") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="200px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="อาชีพ">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCAREER" runat="server" Text='<%# Eval("CAREER") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle Width="130px" />
                                                        <ItemStyle HorizontalAlign="left" Width="100px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="วันเกิด">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblBIRTH_DATE" runat="server" Text='<%# Eval("BIRTH_DATE") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle Width="100px" />
                                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="เลขที่บัตรประชาชน">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblLAWBREAKER_ID_CARD" runat="server" Text='<%# Eval("LAWBREAKER_ID_CARD") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="140px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="เลขที่หนังสือเดินทาง">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblLAWBREAKER_PASSPORT" runat="server" Text='<%# Eval("LAWBREAKER_PASSPORT") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="200px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="เชื้อชาติ">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblrace_id_name" runat="server" Text='<%# Eval("race_id_name") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="100px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="สัญชาติ">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblnationality_id_name" runat="server" Text='<%# Eval("nationality_id_name") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="100px" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="ชื่อบิดา">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFATHER_NAME" runat="server" Text='<%# Eval("FATHER_NAME") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="130px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ชื่อมารดา">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMOTHER_NAME" runat="server" Text='<%# Eval("MOTHER_NAME") %>'></asp:Label></ItemTemplate>
                                                        <HeaderStyle />
                                                        <ItemStyle HorizontalAlign="left" Width="130px" />
                                                    </asp:TemplateField>
                                                </Columns>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="tabCatchNote" ID="tabCatchNote">
                        <HeaderTemplate>
                            <font size="2pt">บันทึกการจับ</font></HeaderTemplate>
                        <ContentTemplate>
                            <table cellspacing="1" width="100%">
                                <tr>
                                    ...
                                    <td style="width: 200px" valign="top">
                                        <asp:TextBox ID="txtBEHAVIOUR" runat="server" Width="260px" Height="95px" TextMode="MultiLine"
                                            Text="รับสารภาพตลอดข้อกล่าวหา" Font-Size="12"></asp:TextBox>
                                    </td>
                                    <td valign="top">
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <asp:TextBox ID="txtTESTIMONY" runat="server" Width="260px" Height="59px" TextMode="MultiLine"
                                            Text="รับสารภาพตลอดข้อกล่าวหา" Font-Size="12"></asp:TextBox>
                                    </td>
                                    <td valign="top">
                                        &nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <asp:TextBox ID="txtAdministration" runat="server" Width="260px" Height="60px" TextMode="MultiLine"
                                            Text="แจ้งให้ญาติทราบ" Font-Size="12"></asp:TextBox>
                                    </td>
                                    <td valign="top">
                                        &nbsp;&nbsp;
                                    </td>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="tabStaffList" ID="tabStaffList">
                        <HeaderTemplate>
                            <font size="2pt">คณะผู้จับกุม</font></HeaderTemplate>
                        <ContentTemplate>
                            <table cellspacing="1" width="100%">
                                <tr>
                                    <td>
                                        &nbsp;<asp:Button ID="btnAddDivide_staff_poplist" runat="server" Text="เพิ่มใหม่"
                                            Width="69px" /><uc7:frmPopArrestTeam ID="frmPopArrestTeam1" runat="server" />
                                        &nbsp;<asp:Button ID="btnDeleteDivide_staff_poplist" runat="server" Text="ลบรายการ" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <HeaderTemplate>
                                                            <asp:CheckBox ID="chkH" runat="server" OnCheckedChanged="chkH_OnCheckedChanged" AutoPostBack="true" /></HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chk" runat="server" /><asp:Label ID="lblidcard_no" runat="server"
                                                                Text='<%# Eval("STAFF_IDCARDNO") %>' Visible="false"></asp:Label><asp:Label ID="lblposcode"
                                                                    runat="server" Text='<%# Eval("STAFF_POSCODE") %>' Visible="false"></asp:Label><asp:Label
                                                                        ID="lbloffcode" runat="server" Text='<%# Eval("STAFF_OFFCODE") %>' Visible="false"></asp:Label></ItemTemplate>
                                                        <HeaderStyle Width="30px" />
                                                        <ItemStyle HorizontalAlign="Center" Width="30px" />
                                                    </asp:TemplateField>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="tabExhibitList" ID="tabExhibitList">
                        <HeaderTemplate>
                            <font size="2pt">บัญชีสิ่งของ(2/39)</font></HeaderTemplate>
                        <ContentTemplate>
                            <table cellspacing="1" width="100%">
                                <tr>
                                    <td>
                                        &nbsp;<asp:Button ID="btnAddArrestExhibit" runat="server" Text="เพิ่มใหม่" Width="69px" /><uc8:frmPopArrestExhibit
                                            ID="frmPopArrestExhibit1" runat="server" />
                                            ...
                                            <asp:GridView ID="gvExhibitList" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ชื่อสินค้า">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lblGroupName" runat="server" Text='<%# Eval("group_name") %>'
                                                                CommandArgument='<%# Eval("seq") %>' CommandName="Edit"></asp:LinkButton><asp:Label
                                                                    ID="lblGroupID" runat="server" Text='<%# Eval("group_id") %>' Visible="false"></asp:Label><asp:Label
                                                                        ID="lblBrandCode" runat="server" Text='<%# Eval("brand_code") %>' Visible="false"></asp:Label><asp:Label
                                                                            ID="lblBrandName" runat="server" Text='<%# Eval("brand_name") %>' Visible="false"></asp:Label></ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="ขนาด">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSizeName" runat="server" Text='<%# Eval("size_name") %>'></asp:Label><asp:Label
                                                                ID="lblSizeDesc" runat="server" Text='<%# Eval("size_desc") %>' Visible="false"></asp:Label><asp:Label
                                                                    ID="lblSizeUnitCode" runat="server" Text='<%# Eval("size_unit_code") %>' Visible="false"></asp:Label><asp:Label
                                                                        ID="lblSizeUnitName" runat="server" Text='<%# Eval("size_unit_name") %>' Visible="false"></asp:Label></ItemTemplate>
                                                        <HeaderStyle Width="100px" />
                                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="จำนวน">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblQtyName" runat="server" Text='<%# Eval("qty_name") %>'></asp:Label><asp:Label
                                                                ID="lblQty" runat="server" Text='<%# Eval("qty") %>' Visible="false"></asp:Label><asp:Label
                                                                    ID="lblQtyUnitCode" runat="server" Text='<%# Eval("qty_unit_code") %>' Visible="false"></asp:Label><asp:Label
                                                                        ID="lblQtyUnitName" runat="server" Text='<%# Eval("qty_unit_name") %>' Visible="false"></asp:Label></ItemTemplate>
                                                        <HeaderStyle Width="100px" />
                                                        <ItemStyle HorizontalAlign="center" Width="100px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ปริมาณสุทธิ">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblWeightName" runat="server" Text='<%# Eval("weight_name") %>'></asp:Label><asp:Label
                                                                ID="lblWeight" runat="server" Text='<%# Eval("weight") %>' Visible="false"></asp:Label><asp:Label
                                                                    ID="lblWeightUnitCode" runat="server" Text='<%# Eval("weight_unit_code") %>'
                                                                    Visible="false"></asp:Label><asp:Label ID="lblWeightUnitName" runat="server" Text='<%# Eval("weight_unit_name") %>'
                                                                        Visible="false"></asp:Label><asp:Label ID="lblExhibitList" runat="server" Text='<%# Eval("exhibit_list") %>'
                    ...
                    <cc1:TabPanel runat="server" HeaderText="tabBookImpeachment" ID="tabBookImpeachment">
                        <HeaderTemplate>
                            <font size="2pt">บันทึกรับคำกล่าวโทษ</font>
                        </HeaderTemplate>
                        <ContentTemplate>
                            <uc9:ucBookImpeachment ID="ucBookImpeachment1" runat="server" />
                        </ContentTemplate>
                    </cc1:TabPanel>
                    <cc1:TabPanel runat="server" HeaderText="tabProveExhisit" ID="tabProveExhisit">
                        <HeaderTemplate>
                            <font size="2pt">พิสูจน์ของกลาง(2/4)</font>
                        </HeaderTemplate>
                        <ContentTemplate>
                            <uc11:ucProveExhibit ID="ucProveExhibit1" runat="server" />
                        </ContentTemplate>
                    </cc1:TabPanel>
                    <cc1:TabPanel runat="server" HeaderText="tabCompareCase" ID="tabCompareCase">
                        <HeaderTemplate>
                            <font size="2pt">เปรียบเทียบปรับ</font>
                        </HeaderTemplate>
                        <ContentTemplate>
                            <uc10:ucCompareCase ID="ucCompareCase1" runat="server" />
                        </ContentTemplate>
                    </cc1:TabPanel>
                    <cc1:TabPanel runat="server" HeaderText="tabPayFine" ID="tabPayFine">
                        <HeaderTemplate>
                            <font size="2pt">ชำระเงินค่าปรับ</font>
                        </HeaderTemplate>
                        <ContentTemplate>
                            <uc12:ucPayFine ID="ucPayFine1" runat="server" />
                        </ContentTemplate>
                    </cc1:TabPanel>
                </cc1:TabContainer>
            </ContentTemplate>
