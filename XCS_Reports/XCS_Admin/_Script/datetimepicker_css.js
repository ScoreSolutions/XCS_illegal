...
function RenderCssCal(bNewCal,pCtrl, pAge) {
  ...
  //******************End Month and Year selector in arrow******************************
    ...
    if (UseImageFiles)
    {
       vCalTime+="<table width='100%'><tr><td width='50%'><a onmousedown='javascript:clearValue(\""+ pCtrl +"\");closewin(\"" + Cal.Ctrl + "\"); stopSpin();' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'>ลบ</a></td><td width='50%' align='right'><a onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();'  width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'>ปิดหน้านี้</a></td></tr></table></td>";
    }
    else
    {
    ...
    funcCalback += " var CalId = document.getElementById(id); if (datum== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + d.getFullYear(); } window.calDatum=datum;CalId.value=datum;calage('" + pCtrl + "','" + pAge + "');\n";
...
function NewCssCalandAge(pCtrl,pFormat,pAge,pScroller,pShowTime,pTimeMode,pHideSeconds) {
	...
	selDate=new Date(Cal.Year,Cal.Month,Cal.Date);//version 1.7
	RenderCssCal(true, pCtrl, pAge);
}
function calage(pCtrl, pAge) {
    //alert(pAge);
    if (pAge != "undefined") {
        if (document.getElementById(pCtrl).value != "") {
            ...
            document.getElementById(pAge).innerHTML = y1 - y2;
        } else {
