Partial Public Class frmSearchDepartment
    ...
    Public Property DepartmentName() As String
        ...
        End Set
    End Property
    Public ReadOnly Property TextDepartmentID() As TextBox
        Get
            Return txtDepartmentID
        End Get
    End Property
    Public ReadOnly Property TextDepartmentName() As TextBox
        Get
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            txtDepartmentID.Attributes.Add("OnKeyPress", "ChkMinusInt(this,event);")
            txtDepartmentID.Attributes.Add("onKeyDown", "CheckKeyNumber(event);")
        End If
    End Sub
