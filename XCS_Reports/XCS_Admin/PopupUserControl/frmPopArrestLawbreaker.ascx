<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="frmPopArrestLawbreaker.ascx.vb" Inherits="XCS_Admin.frmPopArrestLawbreaker" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="../UserControls/txtBirthDate.ascx" TagName="txtBirthDate" TagPrefix="uc1" %>
    ...
    <table cellspacing="1" width="100%">
        ...
        <tr>
            ...
            <td class="style2">
                ...
                <asp:TextBox ID="txtAppLawbreakerID" runat="server" CssClass="zHidden" Text="0"></asp:TextBox>
            </td>
            <td>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="style2">
                <uc1:txtBirthDate ID="txtBirthday" runat="server" />
            </td>
            <td class="style1">
                &nbsp;</td>
        </tr>
