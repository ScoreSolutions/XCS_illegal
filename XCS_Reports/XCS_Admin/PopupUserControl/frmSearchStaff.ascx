<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="frmSearchStaff.ascx.vb" Inherits="XCS_Admin.frmSearchStaff" %>
...
<cc1:ModalPopupExtender ID="zPopSearchStaff" runat="server" PopupControlID="Panel1" TargetControlID="Button1"
