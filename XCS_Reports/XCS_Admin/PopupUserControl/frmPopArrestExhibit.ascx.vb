Public Partial Class frmPopArrestExhibit
    ...
    Public Event SaveExhibit(ByVal sender As Object, ByVal e As System.EventArgs, ByVal GroupID As String, ByVal GroupName As String, ByVal DutyCode As String, ByVal DutyName As String, ByVal IsDomestic As String, ByVal BrandCode As String, ByVal BrandName As String, ByVal SizeDesc As String, ByVal SizeUintCode As String, ByVal SizeUnitName As String, ByVal Qty As String, ByVal QtyUnitCode As String, ByVal QtyUnitName As String, ByVal NetWeight As String, ByVal NetWeightUnitCode As String, ByVal NetWeightUnitName As String, ByVal ExhibitStatus As String, ByVal ExhibitList As String, ByVal ExhibitDesc As String, ByVal CarNo As String, ByVal Remarks As String, ByVal RowID As String, ByVal ExhibitID As Long)
    ...
    End Sub
    Public Sub ShowPopEdit(ByVal RowID As String, ByVal GroupID As String, ByVal DutyCode As String, ByVal IsDomestic As String, ByVal BrandCode As String, ByVal BrandName As String, ByVal SizeDesc As String, ByVal SizeUintCode As String, ByVal Qty As String, ByVal QtyUnitCode As String, ByVal NetWeight As String, ByVal NetWeightUnitCode As String, ByVal ExhibitStatus As String, ByVal ExhibitList As String, ByVal ExhibitDesc As String, ByVal CarNo As String, ByVal Remarks As String, ByVal ExhibitID As Long)
        SetDDLGroupID()
