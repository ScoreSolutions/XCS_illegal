Partial Public Class txtBirthDate
    ...
    Private Function GetDate() As Date
        ...
        If TextBox1.Text.Trim() <> "" Then
            Dim TmpDate As Date = Date.ParseExact(TextBox1.Text, "dd/MM/yyyy", New Globalization.CultureInfo("en-US"))
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            likA.Attributes.Add("onClick", "NewCssCalandAge('" & TextBox1.ClientID & "','DDMMYYYY','" & lblAge.ClientID & "');")
