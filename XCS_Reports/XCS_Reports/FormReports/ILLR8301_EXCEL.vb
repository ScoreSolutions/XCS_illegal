...
Public Class ILLR8301_EXCEL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "XCS_Reports.ILLR8301_EXCEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedILLR8301_EXCEL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ILLR8301_EXCEL = New ILLR8301_EXCEL
        rpt.Site = Me.Site
        Return rpt
    End Function
