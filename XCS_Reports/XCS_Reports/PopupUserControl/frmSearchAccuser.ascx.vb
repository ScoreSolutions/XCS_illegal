Public Partial Class frmSearchAccuser
    Inherits System.Web.UI.UserControl

    Public Event SelectAccuser(ByVal sender As Object, ByVal e As System.EventArgs, ByVal IdCardNo As String, ByVal FullName As String, ByVal PosName As String, ByVal Offname As String, ByVal Poscode As String, ByVal Offcode As String)
    ...
    Private Sub gvData_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvData.RowCommand
        Try
            If e.CommandName = "select" Then
                ...
                RaiseEvent SelectAccuser(sender, e, strValue(0), strValue(1), strValue(2), strValue(3), strValue(4), strValue(5))
